function warn(msg)
{
    ...
    warningWindow.background = makeRect(800, 400, '#ffffff'/*"#f0f0f0"*/, 0.5, "#ffffff", 3);
    warningWindow.background.render(warningWindow.shape, Point(0, 0));
    warningWindow.bar = makeRect(801, 25, "#ffffff", 0, "#ffffff", 3);
    warningWindow.bar.render(warningWindow.shape, Point(0, -25.5));
    warningWindow.killButton=makeDeleteCross(10, 10, "#666"/*"#8b9dc3"*/, 2);
    warningWindow.killButton.render(warningWindow.shape, Point(785, -18));
    ...
    warningWindow.render(topLayer.shape, Point(stageWidth/2-400, stageHeight/2-200));
    ...
    okayButton.renderW(warningWindow, Point(350, 350));
}
